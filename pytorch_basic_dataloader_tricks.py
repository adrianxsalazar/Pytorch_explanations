...
#We can always download a standard dataset using torchvision.
#We are downloading the MNIST dataset.

#Set up the folder where we want to download the dataset. And create if it does
#not exist
image_path='./MNIST'
...
#torchvision.datasets.MNIST Downloads the dataset.
mnist=torchvision.datasets.MNIST(image_path,'train', download=True)
assert isinstance(mnist,torch.utils.data.Dataset)
